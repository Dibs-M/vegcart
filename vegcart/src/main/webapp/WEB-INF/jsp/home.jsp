...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
    ...
    <div class="wrappage">
                ...
                <div class="container container-ver2">
                    <div class="inner-topbar box">
                        <div class="float-left">
                            <p><img src="assets/images/icon-phone-header.png.png" alt="icon"> Call us <span> 9619679476</span></p>
                        </div>
        ...
        <!-- End Slider Home2 -->
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4">
                            <a class="hover-images" href="#" title="images">
                                <img class="img-responsive" src="assets/images/banner/3.jpg" alt="banner">
                            </a>
                        </div>
                        <!--End col-md-4-->
                        <div class="col-md-4 col-sm-4">
                            <a href="#" class="hover-images" title="ịmages">
                                <img class="img-responsive" src="assets/images/banner/4.jpg" alt="banner">
                            </a>
                        </div>
                        <!--End col-md-4-->
                        <div class="col-md-4 col-sm-4">
                            <a href="#" class="hover-images" title="images">
                                <img class="img-responsive" src="assets/images/banner/5.jpg" alt="banner">
                            </a>
                        </div>
                        <!--End col-md-4-->
                    </div>
            ...
            <!-- <div class="bg-slider-one-item space-100 bg-home2-slider">
                <div class="container container-ver2">
                    ...
                    End title
                    <div class="brand-content owl-carousel owl-theme">
                        <div class="items">
        ...
        <div class="container">
            ...
            <div class="box center space-padding-tb-30 space-30">
                <a class="link-v1 color-brand font-300 space-60" href="#" title="View All">View All</a>
            </div>
        </div>
        <!-- End container-ver2 -->
       <!--  <div class="special bg-images special-v2 box" style="background-image:url('assets/images/home1-banner1.jpg');background-repeat: no-repeat;">
            <div class="col-md-7 float-left align-right">
                <img class="images-logo" src="assets/images/home1-images-banner1-2.png" alt="images">
            </div>
            End col-md-7
       ...
       <!--  <div class="container container-ver2 blog-home1">
            ...
            <div class="blog-content slider-three-item owl-carousel owl-theme">
                <div class="item">
                    <a class="hover-images" href="#" title="images">
                        <img class="img-responsive" src="assets/images/ImgBlog/4.jpg" alt="blog">
                    </a>
                    <div class="text-v2">
                ...
                <div class="item">
                    <a class="hover-images" href="#" title="images">
                        <img class="img-responsive" src="assets/images/ImgBlog/5.jpg" alt="blog">
                    </a>
                    <div class="text-v2">
                ...
                <div class="item">
                    <a class="hover-images" href="#" title="images">
                        <img class="img-responsive" src="assets/images/ImgBlog/6.jpg" alt="blog">
                    </a>
                    <div class="text-v2">
