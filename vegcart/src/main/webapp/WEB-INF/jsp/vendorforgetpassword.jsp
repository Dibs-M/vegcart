            ...
            <div class="page-login box space-50">
                <div class="row">
                 <div class="col-md-12 sign-in space-30">
                        ...
                        End social -->
                        <form  method="POST" action="vendoremailcheck" class="needs-validation" novalidate>
                            <div class="group box space-20">
                                <label class="control-label" for="inputemail">Email Id<span class="color">*</span></label>
                            ...
                            <button type="submit" class="link-v1 rt" style="margin-top:10px;" >SEND PASSWORD</button>
