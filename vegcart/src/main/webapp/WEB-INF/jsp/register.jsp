                    ...
                    <div class="col-md-12" id="registrationdiv">
                        <div class="register box space-50">
                           ...
                           <!--  <p>Create your own Rimbus account.</p> -->
                            <form  method="POST" action="addcustomer" class="needs-validation" novalidate>
                                <div class="group box space-20">
                                    <label class="control-label" for="inputemailres">Mobile <span class="color">*</span></label>
                                    <input class="form-control" type="text" placeholder="Enter Your Mobile" id="mobile" name="mobile" pattern=".{10}" required>
                                 ...
                                 <div class="group box space-20">
                                    ...
                                    <input class="form-control" type="text" placeholder="Enter Your Name" id="customerName" name="customerName" required>
                                     <div class="valid-feedback">Valid.</div>
